...
public class Extension3DSceneSimple extends SimpleAbstractScene {
    ...
    public Extension3DSceneSimple(MTApplication mtApplication, String name) {
        ...
        this.registerGlobalInputProcessor(new CursorTracer( this, mtApp));
