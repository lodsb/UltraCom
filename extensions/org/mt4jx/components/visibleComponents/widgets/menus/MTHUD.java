...
public class MTHUD extends MTOverlayContainer implements CSSStylableComponent {
     ...
     * @param menuItems the menu items
     * @param size      the size
     * @param offset    the offset (distance between items)
     * @param position  the position (MTHUD.LEFT, MTHUD.RIGHT, MTHUD.TOP,
     *                  MTHUD.BOTTOM)
     */
     ...
     *
     * @param items the items as int[] (items 1,2,3,...n)
     */
     ...
     * Display a subset of the menu
     *
     * @param items the items as List<MenuItem> to display
     */
