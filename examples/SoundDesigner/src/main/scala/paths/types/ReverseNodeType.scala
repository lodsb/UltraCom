...
/**
* This is the reverse node type.
* A node associated with this type functions as a signal to reverse-play-back the associated path,
* that is, once the node is reached, the path is played back in reverse direction.
*/
object ReverseNodeType extends EndNodeType{

  val Symbol = ConvexRectangle
