...
public class HelloWorldScene extends AbstractScene implements IMTInputEventListener<MTOSCControllerInputEvt> {
	...
	public HelloWorldScene(MTApplication mtApplication, String name) {
		...
		GlobalOSCInputProcessor proc = new GlobalOSCInputProcessor("/test");
