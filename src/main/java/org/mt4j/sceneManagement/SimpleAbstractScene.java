...
import org.mt4j.eventSystem.EventHandler;
 ...
 */
public abstract class SimpleAbstractScene extends EventHandler implements Iscene {
    /**
     * The Constant logger.
     */
    private static final Logger logger = Logger.getLogger(SimpleAbstractScene.class.getName());
...
//		logger.setLevel(Level.DEBUG);
     ...
     * @param name          the name
     */
    public SimpleAbstractScene(MTApplication mtApplication, String name) {
        super();
        this.name = name;
...
//			gl.glDisable(GL2.GL_DEPTH_TEST);
    ...
    // more idiomatic for scala
    public MTCanvas canvas() {
        return mainCanvas;
    }
