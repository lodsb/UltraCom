 ...
 */
public class BlendTransition extends SimpleAbstractTransition {
...
//		((Animation)anim).setResetOnFinish(true);
    ...
    /* (non-Javadoc)
      * @see org.mt4j.sceneManagement.SimpleAbstractScene#drawAndUpdate(processing.core.PGraphics, long)
      */
    @Override
...
//		this.clear(graphics)
    ...
    /* (non-Javadoc)
      * @see org.mt4j.sceneManagement.SimpleAbstractScene#shutDown()
      */
    @Override
