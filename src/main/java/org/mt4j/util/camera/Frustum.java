...
public class Frustum implements IFrustum {
    //	private static float ANG2RAD = (3.14159265358979323846f/360.0f); //FIXME warum /360 ? mÃÂ¯ÃÂ¿ÃÂsste doch /180 sein?
    private float ratio;
    private float angle;
    private float nearD;
    private float farD;
...
//TODO immer wenn sich perspective ÃÂ¯ÃÂ¿ÃÂndert
