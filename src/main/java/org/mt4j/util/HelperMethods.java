...
//    }
     ...
     * 
    //Jede comp mÃÅsste das implementieren, wird vorm rendern abgefragt
...
//    }
     ...
     * @param m           the m
     */
    public static void applyMatrix(PApplet renderer, PGraphicsOpenGL pgraphics3D, Matrix m) {
        switch (RENDERER_STATE) {
            case PROCESSING_MATRIX_MODE:
