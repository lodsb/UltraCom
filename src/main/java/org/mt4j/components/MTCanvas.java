...
//					System.out.println("Time for picking the scene: " + (b-a));
            ...
            //ÃÂ¯ÃÂ¿ÃÂbergeordnetem clusterpoly machen? aber mit clusterPoly.setComposite(TRUE);
...
//				if (iscene instanceof SimpleAbstractScene){
//					SimpleAbstractScene as = (SimpleAbstractScene)iscene;
...
//					drawUpdateRecursive(child, updateTime, graphics);
                ...
                //TODO in abstactvisiblecomp wird outine ÃÂ¯ÃÂ¿ÃÂber gradients und clips
                //gezeichnet obwohl hier invisble war! FIXME!
                //evtl applymatrix unapply in eigene methode? dann nur das ausfÃÂ¯ÃÂ¿ÃÂhren, kein pre/post draw!
