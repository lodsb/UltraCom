...
public class CSSParserConnection {
    ...
    public CSSParserConnection(String source, MTApplication app) {
        ...
        if (exists_css || exists_data || exists_root) {
            ...
            InputStream stream = Thread.currentThread().getContextClassLoader().getResourceAsStream("/home/lodsb/Dokumente/development/intellij_projects/mt4j/src/data/css" + source);

            try {
            InputStreamReader streamReader = new InputStreamReader(new FileInputStream("/home/lodsb/Dokumente/development/intellij_projects/mt4j/src/data/css" + source));
