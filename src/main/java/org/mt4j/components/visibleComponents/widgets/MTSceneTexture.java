...
//			GLStencilUtil.getInstance().endClipping(gl, this);
    ...
    /*TODO
      ...
      *
      * - FBO: mehrere texture targets wenn supported ermÃÂ¯ÃÂ¿ÃÂglichen
      *
      * - FBO: multisampling fbo optional wenn supported machen siehe glgraphicsoffscreen
      *
      * - FBO: bei RECTANGLE dimensions keine mipmaps mÃÂ¯ÃÂ¿ÃÂglich??
      *
      * - FBO: hardware fbo mit glCopyTex2D
      *
      * - nur sceneDrawAndUpdate() wenn sich was verÃÂ¯ÃÂ¿ÃÂndert hat - sonst kann man einfach alte textur lassen! scene.invalidate()?
      *
...
//					newCursor.addEvent(newEvt);
                    ...
                    //TODO checken ob cursor bereits events enthÃÂ¯ÃÂ¿ÃÂlt - ÃÂ¯ÃÂ¿ÃÂberhaupt mÃÂ¯ÃÂ¿ÃÂglich?..
