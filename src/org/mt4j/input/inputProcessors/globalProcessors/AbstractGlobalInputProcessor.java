 ...
 */
public abstract class AbstractGlobalInputProcessor<T extends MTInputEvent> extends EventHandler implements IInputSourceListener<T>, IInputProcessor<T> {
...
//		this.gestureListeners = new ArrayList<IMTEventListener>();
    ...
    public AbstractGlobalInputProcessor(SimpleAbstractScene scene) {
        this();
        scene.registerGlobalInputProcessor(this);
    }
